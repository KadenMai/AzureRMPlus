...
(function(factory) {
  ...
  var yadcf = (function() {
    ...
    function initColReorder2(settingsDt, table_selector_jq_friendly) {
      if (
        settingsDt.oSavedState &&
        settingsDt.oSavedState.ColReorder !== undefined
      ) {
        if (plugins[table_selector_jq_friendly] === undefined) {
          plugins[table_selector_jq_friendly] = {};
          plugins[
            table_selector_jq_friendly
          ].ColReorder = arraySwapValueWithIndex(
            settingsDt.oSavedState.ColReorder
          );
        }
    ...
    function setOptions(selector_arg, options_arg, params, table) {
      ...
      for (i = 0; i < options_arg.length; i++) {
        if (
          options_arg[i].date_format !== undefined &&
          options_arg[i].moment_date_format === undefined
        ) {
        ...
        if (
          options_arg[i].filter_type !== undefined &&
          options_arg[i].filter_type.indexOf("custom_func") !== -1
        ) {
          if (options_arg[i].custom_func === undefined) {
            console.log(
              'Error: You are trying to use filter_type: "custom_func / multi_select_custom_func" for column ' +
                options_arg[i].column_number +
        ...
        if (!options_arg[i].column_selector) {
          ...
          if (isNaN(col_num_as_int)) {
            tmpOptions[options_arg[i].column_number_str] = $.extend(
              true,
              {},
              default_options,
              options_arg[i]
            ...
            tmpOptions[col_num_as_int] = $.extend(
              true,
              {},
              default_options,
              options_arg[i]
          ...
          if (table && table.column) {
            ...
            if (columnNumber.index() >= 0) {
              ...
              tmpOptions[options_arg[i].column_number] = $.extend(
                true,
                {},
                default_options,
                options_arg[i]
    ...
    function initializeSelectPlugin(
      selectType,
      $selectObject,
      select_type_options
    ) {
    ...
    function initSelectPluginCustomTriggers(
      initFunc,
      refreshFunc,
      destroyFunc
    ) {
    ...
    function yadcfMatchFilterString(
      table_arg,
      column_number,
      selected_value,
      filter_match_mode,
      ...
      var case_insensitive = yadcf.getOptions(table_arg.selector)[column_number]
          .case_insensitive,
        ret_val;
      ...
      table_arg.fnSettings().aoPreSearchCols[
        column_number
      ].bCaseInsensitive = case_insensitive;
    ...
    function yadcfMatchFilter(
      ...
      var case_insensitive = yadcf.getOptions(oTable.selector)[
        original_column_number
      ].case_insensitive;
      if (exclude !== true) {
        if (filter_match_mode === "contains") {
    ...
    function doFilterCustomDateFunc(
      arg,
      table_selector_jq_friendly,
      column_number
    ) {
      ...
      if (
        arg === "clear" &&
        exGetColumnFilterVal(oTable, column_number) === ""
      ) {
        return;
      }
    ...
    function calcColumnNumberFilter(
      settingsDt,
      column_number,
      table_selector_jq_friendly
    ) {
      ...
      if (
        ...
        (plugins[table_selector_jq_friendly] !== undefined &&
          plugins[table_selector_jq_friendly].ColReorder !== undefined)
      ) {
        initColReorder2(settingsDt, table_selector_jq_friendly);
        column_number_filter =
          plugins[table_selector_jq_friendly].ColReorder[column_number];
      } else {
    ...
    function doFilter(
      ...
      if (columnObj.exclude) {
        exclude_checked = $(
          ...
          .find(".yadcf-exclude-wrapper :checkbox")
          .prop("checked");
      }
      ...
      $(document).data(
        "#yadcf-filter-" +
          ...
          column_number +
          "_val",
        arg === "exclude" || exclude_checked ? selected_value : arg.value
      );

      if (
        arg.value !== "-1" &&
        selected_value !== columnObj.select_null_option
      ) {
    ...
    function stateSaveNullSelect(
      ...
      const excludeStrEnd = ").)*$";
      null_str = exclude_checked
        ? excludeStrStart + null_str + excludeStrEnd
        : null_str;
      if (oTable.fnSettings().oLoadedState) {
        if (
          oTable.fnSettings().oLoadedState.yadcfState !== undefined &&
      ...
      if (selected_values !== null) {
        ...
        if (selected_values_trimmed.length !== 0) {
          ...
          if (filter_match_mode !== "regex") {
            ...
            stringForSearch = stringForSearch.replace(
              /([.*+?^=!:${}()|\[\]\/\\])/g,
              "\\$1"
            );
    ...
    function addRangeNumberAndSliderFilterCapability(
      table_selector_jq_friendly,
      fromId,
      toId,
      col_num,
      ...
      $.fn.dataTableExt.afnFiltering.push(function(
        ...
        var min,
          ...
          current_table_selector_jq_friendly = yadcf.generateTableSelectorJQFriendly2(
            settingsDt
          ),
        ...
        if (
          table_selector_jq_friendly_local !==
          current_table_selector_jq_friendly
        ) {
          return true;
        }
        ...
        if (rowData !== undefined) {
          ...
          if (columnObj.column_number_render) {
            ...
            const index = columnObj.column_number_data
            ...
            if (
              typeof index === "string" &&
              typeof rowDataRender === "object"
            ) {
              const cellDataRender = columnObj.column_number_render(
              ...
              setProp(
                rowDataRender,
                index,
                cellDataRender !== undefined && cellDataRender !== null
                  ? cellDataRender
                  : getProp(rowData, index)
              );
            } else {
              const cellDataRender = columnObj.column_number_render(
                rowDataRender[index],
        ...
        if (
          ...
          if ($(val).length !== 0) {
            switch (html_data_type) {
              ...
              case "selector":
                val = $(val)
                  .find(columnObj.html_data_selector)
                  .text();
                break;
            }
          }
        ...
        if (columnObj.filter_type === "range_number_slider") {
          if (
            val === "" &&
            (+min !== sliderMaxMin.min || +max !== sliderMaxMin.max)
          ) {
            return false;
          }
        } else {
        ...
        if (!exclude_checked) {
          if (columnObj.range_data_type === "single") {
            ...
            if (columnObj.text_data_delimiter !== undefined) {
              ...
              retVal = valSplitted.some(
                anyNumberInRange({ from: min, to: max })
              );
            }
          }
          return retVal;
    ...
    function addCustomFunctionFilterCapability(
      table_selector_jq_friendly,
      filterId,
      col_num
    ) {
      $.fn.dataTableExt.afnFiltering.push(function(
        ...
        columnVal =
          aData[column_number_filter] === "-" ? 0 : aData[column_number_filter];

        custom_func = getOptions(settingsDt.oInstance.selector)[col_num]
          .custom_func;
    ...
    function addRangeDateFilterCapability(
      table_selector_jq_friendly,
      fromId,
      toId,
      col_num,
      ...
      $.fn.dataTableExt.afnFiltering.push(function(
        ...
        var min =
            document.getElementById(fromId) !== null
              ? document.getElementById(fromId).value
              : "",
          max =
            document.getElementById(toId) !== null
        ...
        if (columnObj.filters_position === "tfoot" && settingsDt.oScroll.sX) {
          ...
          min = document.querySelector(selectorePrefix + "#" + fromId)
            ? document.querySelector(selectorePrefix + "#" + fromId).value
            : "";
          max = document.querySelector(selectorePrefix + "#" + toId)
            ? document.querySelector(selectorePrefix + "#" + toId).value
            : "";
        }
        ...
        if (
          typeof columnObj.column_number_data === "function" ||
          typeof columnObj.column_number_render === "function"
        ) {
          dataRenderFunc = true;
        }
        ...
        try {
          if (
            min.length === date_format.length + 2 ||
            columnObj.datepicker_type.indexOf("bootstrap") !== -1 ||
            columnObj.datepicker_type === "daterangepicker"
          ) {
            if (columnObj.datepicker_type === "jquery-ui") {
              ...
              min =
                min !== "" ? moment(min, columnObj.date_format).toDate() : min;
            } else if (columnObj.datepicker_type === "bootstrap-datepicker") {
              min =
                min !== ""
                  ? dpg.parseDate(min, dpg.parseFormat(columnObj.date_format))
                  : min;
            }
          }
        } catch (err1) {}
        try {
          if (
            max.length === date_format.length + 2 ||
            columnObj.datepicker_type.indexOf("bootstrap") !== -1 ||
            columnObj.datepicker_type === "daterangepicker"
          ) {
            if (columnObj.datepicker_type === "jquery-ui") {
              ...
              max =
                max !== "" ? moment(max, columnObj.date_format).toDate() : max;
            } else if (columnObj.datepicker_type === "bootstrap-datepicker") {
              max =
                max !== ""
                  ? dpg.parseDate(max, dpg.parseFormat(columnObj.date_format))
                  : max;
            }
          }
        } catch (err2) {}
        try {
          if (columnObj.datepicker_type === "jquery-ui") {
            ...
            val =
              val !== ""
                ? moment(val, columnObj.moment_date_format).toDate()
                : val;
          } else if (columnObj.datepicker_type === "bootstrap-datepicker") {
            val =
              val !== ""
                ? dpg.parseDate(val, dpg.parseFormat(columnObj.date_format))
                : val;
          } else if (columnObj.datepicker_type === "daterangepicker") {
            val =
              val !== "" ? moment(val, columnObj.date_format).toDate() : val;
          }
        } catch (err3) {}

        if (date_format.toLowerCase() !== "hh:mm") {
          if (
            (min === "" || !(min instanceof Date)) &&
            (max === "" || !(max instanceof Date))
          ) {
            retVal = true;
          } else if (min === "" && val <= max) {
            retVal = true;
          ...
          if (
            (min === "" || !moment(min, date_format).isValid()) &&
            (max === "" || !moment(max, date_format).isValid())
          ) {
            retVal = true;
    ...
    function addNullFilterCapability(
      table_selector_jq_friendly,
      col_num,
      isSelect
    ) {
      $.fn.dataTableExt.afnFiltering.push(function(
        ...
        var fixedPrefix = "";
        if (
          settingsDt._fixedHeader !== undefined &&
          $(".fixedHeader-floating").is(":visible")
        ) {
        ...
        null_checked = $(
          ...
          .find(".yadcf-null-wrapper :checkbox")
          .prop("checked");
        null_checked = isSelect
          ? $.trim(
              $("#yadcf-filter-" + table_selector_jq_friendly + "-" + col_num)
                .find("option:selected")
                .val()
            ) === columnObj.select_null_option
          : null_checked;
        ...
        if (rowData !== undefined) {
          ...
          if (columnObj.column_number_render) {
            ...
            if (
              ...
              rowDataRender[index] =
                cellDataRender !== undefined ? cellDataRender : rowData[index];
            }
          }
          aData = rowDataRender ? rowDataRender : rowData;
          if (columnObj.column_number_data !== undefined) {
    ...
    function addRangeNumberFilter(
      ...
      var fromId =
          ...
          column_number,
        toId =
          "yadcf-filter-" + table_selector_jq_friendly + "-to-" + column_number,
      ...
      $(filter_selector_string).append(
        '<div onmousedown="yadcf.stopPropagation(event);" onclick="yadcf.stopPropagation(event);"  id="' +
          filter_wrapper_id +
          '" class="yadcf-filter-wrapper ' +
          columnObj.style_class +
          '"></div>'
      );
      ...
      $(filter_selector_string).append(
        '<div id="yadcf-filter-wrapper-inner-' +
          table_selector_jq_friendly +
          "-" +
          column_number +
      ...
      filterActionStr =
        "onkeyup=\"yadcf.rangeNumberKeyUP('" +
        table_selector_jq_friendly +
        "',event);\"";
      ...
      $(filter_selector_string).append(
        '<input onkeydown="yadcf.preventDefaultForEnter(event);" placeholder="' +
          filter_default_label[0] +
          '" id="' +
          fromId +
      ...
      $(filter_selector_string).append(
        '<span class="yadcf-filter-range-number-seperator" >' + "</span>"
      );
      $(filter_selector_string).append(
        '<input onkeydown="yadcf.preventDefaultForEnter(event);" placeholder="' +
          filter_default_label[1] +
          '" id="' +
          toId +
          '" class="yadcf-filter-range-number yadcf-filter-range" ' +
          filterActionStr +
      ...
      if (filter_reset_button_text !== false) {
        $(filter_selector_string_tmp).append(
          '<button type="button" id="yadcf-filter-' +
            table_selector_jq_friendly +
            "-" +
            column_number +
            '-reset" onmousedown="yadcf.stopPropagation(event);" ' +
            "onclick=\"yadcf.stopPropagation(event);yadcf.rangeClear('" +
            table_selector_jq_friendly +
            "',event," +
            column_number +
            '); return false;" class="yadcf-filter-reset-button ' +
            columnObj.reset_button_style_class +
            '">' +
            filter_reset_button_text +
            "</button>"
        );
      ...
      if (
        ...
        $(filter_selector_string_tmp).append(
          '<button type="button" ' +
            ...
            "-" +
            column_number +
            '-externally_triggered_checkboxes-button" onmousedown="yadcf.stopPropagation(event);" ' +
            'onclick="yadcf.stopPropagation(event);" class="yadcf-filter-externally_triggered_checkboxes-button ' +
            columnObj.externally_triggered_checkboxes_button_style_class +
            '">' +
            columnObj.externally_triggered_checkboxes_text +
            "</button>"
        );
        $(
          "#yadcf-filter-" +
            ...
            "-" +
            column_number +
            "-externally_triggered_checkboxes-button"
        ).on("click", columnObj.externally_triggered_checkboxes_function);
      }
      ...
      if (columnObj.exclude === true) {
        if (columnObj.externally_triggered !== true) {
          exclude_str =
            '<span class="yadcf-exclude-wrapper" onmousedown="yadcf.stopPropagation(event);" onclick="yadcf.stopPropagation(event);">' +
            '<div class="yadcf-label small">' +
            columnObj.exclude_label +
            '</div><input type="checkbox" title="' +
            columnObj.exclude_label +
            '" onclick="yadcf.stopPropagation(event);yadcf.rangeNumberKeyUP(\'' +
            table_selector_jq_friendly +
            "',event);\"></span>";
        } else {
          exclude_str =
            ...
            '</div><input type="checkbox" title="' +
            columnObj.exclude_label +
            '" onclick="yadcf.stopPropagation(event);"></span>';
        }
      }
      ...
      if (columnObj.null_check_box === true) {
        if (columnObj.externally_triggered !== true) {
          null_str =
            '<span class="yadcf-null-wrapper" onmousedown="yadcf.stopPropagation(event);" onclick="yadcf.stopPropagation(event);">' +
            '<div class="yadcf-label small">' +
            columnObj.null_label +
            '</div><input type="checkbox" title="' +
            columnObj.null_label +
            '" onclick="yadcf.stopPropagation(event);yadcf.nullChecked(event,\'' +
            table_selector_jq_friendly +
            "'," +
            column_number +
            ');"></span>';
      ...
      let append_checkboxes = columnObj.checkbox_position_after
        ? exclude_str.replace(
            "yadcf-exclude-wrapper",
            "yadcf-exclude-wrapper after"
          ) + null_str.replace("yadcf-null-wrapper", "yadcf-null-wrapper after")
      ...
      if (
        ...
        if (
          ...
          if (columnObj.null_check_box) {
            null_checked = oTable.fnSettings().oLoadedState.yadcfState[
              table_selector_jq_friendly
            ][column_number].null_checked;
            $("#" + filter_wrapper_id)
              .find(".yadcf-null-wrapper :checkbox")
              .prop("checked", null_checked);
            if (columnObj.exclude) {
              exclude_checked = oTable.fnSettings().oLoadedState.yadcfState[
                table_selector_jq_friendly
              ][column_number].exclude_checked;
              $("#" + filter_wrapper_id)
                .find(".yadcf-exclude-wrapper :checkbox")
                .prop("checked", exclude_checked);
            }
          }
          ...
          if (null_checked) {
            ...
            const inuseClass = exclude_checked
              ? " inuse inuse-exclude"
              : " inuse ";
            if (
              oTable.fnSettings().oLoadedState.yadcfState[
      ...
      if (oTable.fnSettings().oFeatures.bServerSide !== true) {
        addRangeNumberAndSliderFilterCapability(
          table_selector_jq_friendly,
          fromId,
          toId,
          column_number,
    ...
    function dateSelectSingle(pDate, pEvent, clear) {
      ...
      // Kaden: try to remove the default filter
      if (clear === undefined) {
    ...
    function dateSelect(pDate, pEvent) {
      ...
      if (pDate.type === "dp") {
        ...
        if (
          pDate.date === false ||
          !moment($(event).val(), columnObj.date_format).isValid()
        ) {
      ...
      keyUp = function() {
        if (oTable.fnSettings().oFeatures.bServerSide !== true) {
          ...
          oTable.fnFilter(
            from + columnObj.custom_range_delimiter + to,
            column_number_filter
          );
        }
    ...
    function addRangeDateFilter(
      ...
      if (columnObj.datepicker_type === "jquery-ui") {
        if (columnObj.jquery_ui_datepicker_locale) {
          $.extend(
            datepickerObj,
            $.datepicker.regional[columnObj.jquery_ui_datepicker_locale]
          );
        }
    ...
    function addDateFilter(
      ...
      if (filter_reset_button_text !== false) {
        $(filter_selector_string_tmp).append(
          '<button type="button" id="' +
            ...
            "onclick=\"yadcf.stopPropagation(event);yadcf.dateSelectSingle('" +
            table_selector_jq_friendly +
            "',yadcf.eventTargetFixUp(event).target, 'clear'); return false;\" class=\"yadcf-filter-reset-button " +
            columnObj.reset_button_style_class +
            '">' +
            filter_reset_button_text +
            "</button>"
      ...
      if (columnObj.datepicker_type === "jquery-ui") {
        ...
        columnObj.datepicker_type.indexOf("bootstrap") !== -1 ||
        columnObj.datepicker_type === "dt-datetime"
      ) {
        datepickerObj.format = date_format;
      } else if (columnObj.datepicker_type === "daterangepicker") {
      ...
      if (columnObj.datepicker_type === "jquery-ui") {
        ...
        $("#" + dateId).on(
          "apply.daterangepicker, hide.daterangepicker",
          function(ev, picker) {
      ...
      if (columnObj.filter_type === "date_custom_func") {
        ...
        if (settingsDt.oFeatures.bServerSide !== true) {
          addCustomFunctionFilterCapability(
            table_selector_jq_friendly,
            "yadcf-filter-" + table_selector_jq_friendly + "-" + column_number,
            column_number
          );
    ...
    function rangeNumberSldierDrawTips(
      min_tip_val,
      max_tip_val,
      min_tip_id,
      max_tip_id,
      ...
      if (first_handle.length === 1) {
        ...
        $(first_handle)
          .addClass("yadcf-filter-range-number-slider-min-tip")
          .html(min_tip_inner);
        ...
        $(last_handle)
          .addClass("yadcf-filter-range-number-slider-max-tip")
          .html(max_tip_inner);
      } else {
    ...
    function rangeNumberSliderChange(table_selector_jq_friendly, event, ui) {
      ...
      event = eventTargetFixUp(event);
      column_number = $(event.target)
        .attr("id")
        .replace("yadcf-filter-", "")
        .replace(table_selector_jq_friendly, "")
        .replace("-slider-", "");
      ...
      keyUp = function() {
        ...
        if (oTable.fnSettings().oFeatures.bServerSide !== true) {
          ...
          oTable.fnFilter(
            ui.values[0] + columnObj.custom_range_delimiter + ui.values[1],
            column_number_filter
          );
        }
        min_val = +$(
          $(event.target)
            .parent()
            .find(".yadcf-filter-range-number-slider-min-tip-hidden")
        ).text();
        max_val = +$(
          $(event.target)
            .parent()
            .find(".yadcf-filter-range-number-slider-max-tip-hidden")
        ).text();
    ...
    function addRangeNumberSliderFilter(
      ...
      if (
        $("#" + filter_wrapper_id).length > 0 &&
        (currSliderMin === min_val && currSliderMax === max_val)
      ) {
        return;
      }
      ...
      if (
        isFinite(min_val) &&
        isFinite(max_val) &&
        isFinite(min_state_val) &&
        isFinite(max_state_val)
      ) {
        //add a wrapper to hold both filter and reset button
        $(filter_selector_string).append(
          '<div onmousedown="yadcf.stopPropagation(event);" onclick="yadcf.stopPropagation(event);"  id="' +
        ...
        $(filter_selector_string).append(
          '<div id="yadcf-filter-wrapper-inner-' +
            ...
            "-" +
            column_number +
            '" class="yadcf-number-slider-filter-wrapper-inner' +
            " -" +
            table_selector_jq_friendly +
            "-" +
            column_number +
        ...
        filter_selector_string +=
          " div.yadcf-number-slider-filter-wrapper-inner";

        $(filter_selector_string).append(
          '<div id="' +
            sliderId +
            '" class="yadcf-filter-range-number-slider"></div>'
        );
        filter_selector_string += " #" + sliderId;

        $(filter_selector_string).append(
          '<span class="yadcf-filter-range-number-slider-min-tip-hidden hide">' +
            min_val +
            "</span>"
        );
        $(filter_selector_string).append(
          '<span class="yadcf-filter-range-number-slider-max-tip-hidden hide">' +
            max_val +
            "</span>"
        );
        ...
        if (columnObj.externally_triggered !== true) {
          ...
          changeFunc = function(event, ui) {
            ...
            if (
              event.originalEvent ||
              $(event.target).slider("option", "yadcf-reset") === true
            ) {
        ...
        if (filter_reset_button_text !== false) {
          $(filter_selector_string_tmp).append(
            '<button type="button" onmousedown="yadcf.stopPropagation(event);" ' +
              "onclick=\"yadcf.stopPropagation(event);yadcf.rangeNumberSliderClear('" +
              table_selector_jq_friendly +
      ...
      if (settingsDt.oFeatures.bStateSave === true && settingsDt.oLoadedState) {
        if (
          ...
          if (
            ...
            $($(filter_selector_string).find(".ui-slider-handle")[0]).addClass(
              "inuse"
            );
          }
          if (
            ...
            $($(filter_selector_string).find(".ui-slider-handle")[1]).addClass(
              "inuse"
            );
          }
          if (
            ...
            $($(filter_selector_string).find(".ui-slider-range")).addClass(
              "inuse"
            );
          }
        }
    ...
    function destroyThirdPartyPlugins(table_arg) {
      ...
      table_selector_jq_friendly = yadcf.generateTableSelectorJQFriendly2(
        table_arg
      );
    ...
    function removeFilters(oTable) {
      ...
      if ($.fn.dataTableExt.afnFiltering.length > 0) {
        $.fn.dataTableExt.afnFiltering.splice(
          0,
          $.fn.dataTableExt.afnFiltering.length
        );
      }
    ...
    function sortColumnData(column_data, columnObj) {
      if (
        columnObj.filter_type === "select" ||
        columnObj.filter_type === "auto_complete" ||
        columnObj.filter_type === "multi_select" ||
        columnObj.filter_type === "multi_select_custom_func" ||
    ...
    function parseTableColumn(
      ...
      column_number_filter = calcColumnNumberFilter(
        settingsDt,
        columnObj.column_number,
        table_selector_jq_friendly
      );
      if (
        isNaN(settingsDt.aoColumns[column_number_filter].mData) &&
        typeof settingsDt.aoColumns[column_number_filter].mData !== "object"
      ) {
        columnObj.column_number_data =
          settingsDt.aoColumns[column_number_filter].mData;
      }
      if (
        isNaN(settingsDt.aoColumns[column_number_filter].mRender) &&
        typeof settingsDt.aoColumns[column_number_filter].mRender !== "object"
      ) {
        columnObj.column_number_render =
          settingsDt.aoColumns[column_number_filter].mRender;
      }
      ...
      for (j = 0; j < data_length; j++) {
        if (columnObj.column_data_type === "html") {
            ...
            for (k = 0; k < col_inner_elements.length; k++) {
              ...
              switch (columnObj.html_data_type) {
                ...
                case "id":
                  ...
                  break;
                case "selector": {
                  const len = $(col_inner_elements[k]).find(
                    columnObj.html_data_selector
                  ).length;
                  if (len === 1) {
                    ...
                    col_inner_data_helper = $(col_inner_elements[k]).find(
                      columnObj.html_data_selector
                    );
                  }
                  break;
              ...
              if (col_inner_data || col_inner_data_helper) {
                if (!col_inner_data_helper) {
                  if (
                    $.trim(col_inner_data) !== "" &&
                    !col_filter_array.hasOwnProperty(col_inner_data)
                  ) {
                  ...
                  col_inner_data_helper.each(function(index) {
                    ...
                    if (
                      $.trim(elm) !== "" &&
                      !col_filter_array.hasOwnProperty(elm)
                    ) {
          ...
          if (columnObj.text_data_delimiter !== undefined) {
            if (columnObj.column_number_data === undefined) {
              col_inner_elements = data[j]._aData[column_number_filter].split(
                columnObj.text_data_delimiter
              );
            } else {
              col_inner_elements = dot2obj(
                data[j]._aData,
              ...
              col_inner_elements = (col_inner_elements + "").split(
                columnObj.text_data_delimiter
              );
            }
            for (k = 0; k < col_inner_elements.length; k++) {
            ...
            if (columnObj.column_number_data === undefined) {
              ...
              if (typeof col_inner_data === "object") {
                if (columnObj.html5_data !== undefined) {
                  ...
                  console.log(
                    "Warning: Looks like you have forgot to define the html5_data attribute for the " +
                      columnObj.column_number +
                      " column"
                  );
                  return;
              ...
              data[j]._aFilterData !== undefined &&
              data[j]._aFilterData !== null
            ) {
              col_inner_data = data[j]._aFilterData[column_number_filter];
            } else {
              col_inner_data = dot2obj(
                data[j]._aData,
                columnObj.column_number_data
              );
            }
          ...
          if (data[j]._aFilterData) {
            ...
            console.log(
              "Looks like you missing column_data_render function for the column " +
                column_number_filter
            );
          }
    ...
    function appendFilters(oTable, args, table_selector, pSettings) {
      ...
      if (settingsDt.oScroll.sX !== "" || settingsDt.oScroll.sY !== "") {
        table_selector =
          ".yadcf-datatables-table-" + table_selector_jq_friendly;
      ...
      for (columnObjKey in args) {
        if (args.hasOwnProperty(columnObjKey)) {
          ...
          if (
            ...
            columnObj.column_number_render =
              settingsDt.aoColumns[column_position].mRender;
          }
          ...
          externally_triggered_checkboxes_text =
            columnObj.externally_triggered_checkboxes_text;
          externally_triggered_checkboxes_function =
            columnObj.externally_triggered_checkboxes_function;
          ...
          if (
            columnObj.ignore_char !== undefined &&
            !(columnObj.ignore_char instanceof RegExp)
          ) {
          ...
          if (filter_default_label === undefined) {
            if (
              ...
              columnObj.filter_type === "auto_complete" ||
              columnObj.filter_type === "text"
            ) {
              filter_default_label = placeholderLang.filter;
            } else if (
              columnObj.filter_type === "range_number" ||
              columnObj.filter_type === "range_date"
            ) {
              filter_default_label = placeholderLang.range;
            } else if (
              columnObj.filter_type === "date" ||
              columnObj.filter_type === "date_custom_func"
            ) {
          ...
          if (
            data === undefined ||
            columnObj.append_data_to_table_data !== undefined
          ) {
            columnObj.col_filter_array = undefined;
            column_data_temp = parseTableColumn(
              oTable,
              columnObj,
              table_selector_jq_friendly,
              settingsDt
          ...
          if (
            columnObj.append_data_to_table_data === undefined ||
            columnObj.append_data_to_table_data === "sorted"
          ) {
          ...
          if (columnObj.filter_type === "range_number_slider") {
            ...
            if (columnObj.column_number_render) {
              ...
              column_data_render.forEach((data, index) => {
                ...
                const indexData = columnObj.column_number_data
                  ? columnObj.column_number_data
                  : index;
                if (
                  typeof indexData === "string" &&
                  typeof column_data_render === "object"
                ) {
                  const cellDataRender = columnObj.column_number_render(
                    getProp(column_data_render, indexData),
                    "filter",
                    column_data,
                    meta
                  );
                  setProp(
                    ...
                    cellDataRender !== undefined && cellDataRender !== null
                      ? cellDataRender
                      : getProp(column_data, indexData)
                  );
                } else {
                  const cellDataRender = columnObj.column_number_render(
                    column_data_render[indexData],
                    "filter",
                    column_data,
                    meta
                  );
                  column_data_render[indexData] =
                    cellDataRender !== undefined && cellDataRender !== null
                      ? cellDataRender
                      : column_data[indexData];
                }
              });
            }
            min_val = findMinInArray(
              column_data_render ? column_data_render : column_data,
              columnObj
            );
            max_val = findMaxInArray(
              column_data_render ? column_data_render : column_data,
              columnObj
            );
          }
          ...
          if (
            ...
            columnObj.filter_container_selector === undefined
          ) {
            ...
            if (filters_position !== "thead") {
              if (unique_th === undefined) {
                ...
                for (
                  ...
                  col_num_visible_iter < settingsDt.aoColumns.length &&
                  col_num_visible_iter < column_position;
                  col_num_visible_iter++
                ) {
                  if (
                    settingsDt.aoColumns[col_num_visible_iter].bVisible ===
                    false
                  ) {
                    col_num_visible--;
                  }
                ...
                filter_selector_string =
                  ...
                  filters_position +
                  " th:eq(" +
                  $(unique_th[column_position]).index() +
                  ")";
              }
            } else {
            ...
            if (
              columnObj.select_type === "select2" ||
              columnObj.select_type === "custom_select"
            ) {
              $filter_selector = $(filter_selector_string).find(
                "select.yadcf-filter"
              );
            }
          } else {
            ...
            if ($(columnObj.filter_container_selector).length === 0) {
              console.log(
                "ERROR: Filter container could not be found, columnObj.filter_container_selector: " +
                  columnObj.filter_container_selector
              );
              continue;
            }
            ...
            if (columnObj.data_as_is !== true) {
              if (columnObj.omit_default_label !== true) {
                if (
                  ...
                  if (
                    columnObj.select_type === "select2" &&
                    columnObj.select_type_options.placeholder !== undefined &&
                    columnObj.select_type_options.allowClear === true
                  ) {
              ...
              if (columnObj.append_data_to_table_data === undefined) {
                if (typeof column_data[0] === "object") {
                  for (ii = 0; ii < column_data.length; ii++) {
                    options_tmp +=
                      '<option value="' +
                      (column_data[ii].value + "").replace(/"/g, "&quot;") +
                      '">' +
                      column_data[ii].label +
                      "</option>";
                  }
                } else {
                  for (ii = 0; ii < column_data.length; ii++) {
          ...
          if ($filter_selector.length === 1) {
            if (
              ...
              if (
                !columnObj.select_type_options ||
                !columnObj.select_type_options.ajax
              ) {
                $filter_selector.empty();
                $filter_selector.append(column_data);
                if (
                  settingsDt.aoPreSearchCols[column_position].sSearch !== ""
                ) {
                  tmpStr = settingsDt.aoPreSearchCols[column_position].sSearch;
                  if (columnObj.filter_type === "select") {
                    tmpStr = yadcfParseMatchFilter(
                      tmpStr,
                      getOptions(oTable.selector)[column_number]
                        .filter_match_mode
                    );
                    let filter = $(
                      "#yadcf-filter-" +
                    ...
                    let optionExists =
                      filter.find("option[value='" + tmpStr + "']").length ===
                      1;
                    ...
                    tmpStr = yadcfParseMatchFilterMultiSelect(
                      tmpStr,
                      getOptions(oTable.selector)[column_number]
                        .filter_match_mode
                    );
              ...
              initializeSelectPlugin(
                columnObj.select_type,
                $(
                  "#yadcf-filter-" +
                    table_selector_jq_friendly +
                    "-" +
              ...
              if (
                columnObj.cumulative_filtering === true &&
                columnObj.select_type === "chosen"
              ) {
                refreshSelectPlugin(
                  columnObj,
                  $(
            ...
            if (
              ...
              if (
                $(filter_selector_string + " div.DataTables_sort_wrapper")
                  .length > 0
              ) {
                $(filter_selector_string + " div.DataTables_sort_wrapper").css(
                  "display",
                  "inline-block"
                );
              }
              ...
              if (
                $(
                  "#yadcf-filter-wrapper-" +
                    generateTableSelectorJQFriendlyNew(
                      columnObj.filter_container_selector
                    )
                ).length === 0
              ) {
                $(columnObj.filter_container_selector).append(
                  '<div id="yadcf-filter-wrapper-' +
                    generateTableSelectorJQFriendlyNew(
                      columnObj.filter_container_selector
                    ) +
                    '"></div>'
            ...
            if (
              ...
              if (columnObj.filter_type === "select") {
                ...
                $(filter_selector_string).append(
                  '<select id="yadcf-filter-' +
                    ...
                    '" ' +
                    filterActionStr +
                    ' onkeydown="yadcf.preventDefaultForEnter(event);" onmousedown="yadcf.stopPropagation(event);" onclick=\'yadcf.stopPropagation(event);\'>' +
                    column_data +
                    "</select>"
                );
                if (filter_reset_button_text !== false) {
                  $(filter_selector_string)
                    ...
                    .after(
                      '<button type="button" ' +
                        ...
                        "-" +
                        column_number +
                        '-reset" onmousedown="yadcf.stopPropagation(event);" onclick="yadcf.stopPropagation(event);yadcf.doFilter(\'clear\', \'' +
                        table_selector_jq_friendly +
                        "', " +
                        column_number +
                        '); return false;" class="yadcf-filter-reset-button ' +
                ...
                if (columnObj.exclude === true) {
                  exclude_str =
                    ...
                    '</div><input type="checkbox" title="' +
                    columnObj.exclude_label +
                    "\" onclick=\"yadcf.stopPropagation(event);yadcf.doFilter('exclude','" +
                    table_selector_jq_friendly +
                    "'," +
                    column_number +
                    ", '" +
                ...
                exclude_str = columnObj.checkbox_position_after
                  ? exclude_str.replace(
                      "yadcf-exclude-wrapper",
                      "yadcf-exclude-wrapper after"
                    )
                ...
                filterActionStr =
                  "onchange=\"yadcf.doFilterCustomDateFunc(this, '" +
                  table_selector_jq_friendly +
                  "', " +
                  column_number +
                  ');"';
                ...
                if (filter_reset_button_text !== false) {
                  $(filter_selector_string)
                    ...
                    .after(
                      '<button type="button" onmousedown="yadcf.stopPropagation(event);" ' +
                        "onclick=\"yadcf.stopPropagation(event);yadcf.doFilterCustomDateFunc('clear', '" +
                        table_selector_jq_friendly +
                        "', " +
                        column_number +
                        '); return false;" class="yadcf-filter-reset-button ' +
              ...
              if (settingsDt.aoPreSearchCols[column_position].sSearch !== "") {
                ...
                tmpStr = yadcfParseMatchFilter(
                  tmpStr,
                  getOptions(oTable.selector)[column_number].filter_match_mode
                );
                const match_mode = getOptions(oTable.selector)[column_number]
                  .filter_match_mode;
                let null_str = columnObj.select_null_option;
                let excludeStrStart = "^((?!";
                let excludeStrEnd = ").)*$";
                ...
                null_str = "^((?!" + null_str + ").)*$";
                null_str = yadcfParseMatchFilter(
                  null_str,
                  getOptions(oTable.selector)[column_number].filter_match_mode
                );
                ...
                if (null_str === tmpStr) {
                  ...
                  tmpStr.includes(excludeStrStart) &&
                  tmpStr.includes(excludeStrEnd)
                ) {
                  exclude = true;
                ...
                tmpStr = escapeRegExp(tmpStr);
                let optionExists =
                  filter.find("option[value='" + tmpStr + "']").length === 1;
                // Set the state preselected value only if the option exists in the select dropdown.
                if (optionExists) {
                  filter.val(tmpStr).addClass("inuse");
                  if (exclude) {
              ...
              if (columnObj.filter_type === "multi_select") {
                filterActionStr =
                  "onchange=\"yadcf.doFilterMultiSelect(this, '" +
                  table_selector_jq_friendly +
                  "', " +
                  column_number +
                  ", '" +
                ...
                if (filter_reset_button_text !== false) {
                  $(filter_selector_string)
                    ...
                    .after(
                      '<button type="button" onmousedown="yadcf.stopPropagation(event);" ' +
                        "onclick=\"yadcf.stopPropagation(event);yadcf.doFilter('clear', '" +
                        table_selector_jq_friendly +
                        "', " +
                        column_number +
                        '); return false;" class="yadcf-filter-reset-button ' +
              ...
              if (
                columnObj.filter_container_selector === undefined &&
                columnObj.select_type_options.width === undefined
              ) {
                columnObj.select_type_options = $.extend(
                  columnObj.select_type_options,
                  {
                    width:
                      $(filter_selector_string)
              ...
              if (
                ...
                columnObj.select_type_options = $.extend(
                  columnObj.select_type_options,
                  {
                    width:
                      $(filter_selector_string)
                        .closest(columnObj.filter_container_selector)
                        .width() + "px"
                  }
                );
              }
              ...
              filterActionStr =
                "onkeyup=\"yadcf.autocompleteKeyUP('" +
                table_selector_jq_friendly +
                "',event);\"";
              if (columnObj.externally_triggered === true) {
                filterActionStr = "";
              ...
              $(filter_selector_string).append(
                '<input onkeydown="yadcf.preventDefaultForEnter(event);" id="yadcf-filter-' +
                  table_selector_jq_friendly +
                  "-" +
                  column_number +
                  '" class="yadcf-filter" onmousedown="yadcf.stopPropagation(event);" onclick=\'yadcf.stopPropagation(event);' +
                  "' placeholder='" +
                  filter_default_label +
                  "'" +
                  " filter_match_mode='" +
              ...
              if (filter_reset_button_text !== false) {
                $(filter_selector_string)
                  ...
                  .after(
                    '<button type="button" onmousedown="yadcf.stopPropagation(event);" ' +
                      "onclick=\"yadcf.stopPropagation(event);yadcf.doFilterAutocomplete('clear', '" +
                      table_selector_jq_friendly +
                      "', " +
                      column_number +
                      '); return false;" class="yadcf-filter-reset-button ' +
              ...
              if (columnObj.exclude === true) {
                if (columnObj.externally_triggered !== true) {
                  exclude_str =
                    ...
                    '</div><input type="checkbox" title="' +
                    columnObj.exclude_label +
                    '" onclick="yadcf.stopPropagation(event);yadcf.textKeyUP(event,\'' +
                    table_selector_jq_friendly +
                    "'," +
                    column_number +
                    ');"></span>';
              ...
              if (columnObj.regex_check_box === true) {
                if (columnObj.externally_triggered !== true) {
                  regex_str =
                    '<span class="yadcf-regex-wrapper" onmousedown="yadcf.stopPropagation(event);" onclick="yadcf.stopPropagation(event);">' +
                    '<div class="yadcf-label small">' +
                    columnObj.regex_label +
                    '</div><input type="checkbox" title="' +
                    columnObj.regex_label +
                    '" onclick="yadcf.stopPropagation(event);yadcf.textKeyUP(event,\'' +
                    table_selector_jq_friendly +
              ...
              let append_input =
                '<input type="text" onkeydown="yadcf.preventDefaultForEnter(event);" id="yadcf-filter-' +
                table_selector_jq_friendly +
                "-" +
                column_number +
                '" class="yadcf-filter ' +
                columnObj.style_class +
                '" onmousedown="yadcf.stopPropagation(event);" onclick=\'yadcf.stopPropagation(event);' +
                "' placeholder='" +
                filter_default_label +
                "'" +
                " filter_match_mode='" +
              ...
              let append_checkboxes = columnObj.checkbox_position_after
                ? append_input +
                  ...
                  regex_str.replace(
                    "yadcf-regex-wrapper",
                    "yadcf-regex-wrapper after"
                  ) +
                  null_str.replace(
                    "yadcf-null-wrapper",
                    "yadcf-null-wrapper after"
                  )
              ...
              if (
                externally_triggered_checkboxes_text &&
                typeof externally_triggered_checkboxes_function === "function"
              ) {
                const sel = $(
                  "#yadcf-filter-wrapper-" +
                    table_selector_jq_friendly +
                ...
                $(
                  "#yadcf-filter-" +
                    ...
                    column_number +
                    "-externally_triggered_checkboxes-button"
                ).on("click", externally_triggered_checkboxes_function);
              }
                ...
                $(filter_selector_string)
                  ...
                  .after(
                    '<button type="button" ' +
                      ...
                      "', '" +
                      column_number +
                      "', 'clear'); return false;\" class=\"yadcf-filter-reset-button " +
                      columnObj.reset_button_style_class +
                      '">' +
                      filter_reset_button_text +
                      "</button>"
    ...
    function loadFromStateSaveTextFilter(
      oTable,
      settingsDt,
      columnObj,
      table_selector_jq_friendly,
    ...
    function rangeClear(table_selector_jq_friendly, event, column_number) {
      ...
      if (columnObj.null_check_box) {
        $("#" + fromId.replace("-from-date-", "-from-")).prop(
          "disabled",
          false
        );
      ...
      const buttonSelector =
        $(event.target).prop("nodeName") === "BUTTON"
          ? $(event.target).parent()
          : $(event.target)
              .parent()
              .parent();
      ...
      buttonSelector
        .parent()
        .find(".yadcf-filter-range")
        .removeClass("inuse inuse-exclude");
      if (columnObj.datepicker_type === "bootstrap-datepicker") {
        $fromInput = $("#" + fromId);
        $toInput = $("#" + toId);
    ...
    function rangeNumberSliderClear(table_selector_jq_friendly, event) {
      ...
      column_number = parseInt(
        buttonSelector
          .prev()
          .find(".yadcf-filter-range-number-slider")
          .attr("id")
          .replace(
            "yadcf-filter-" + table_selector_jq_friendly + "-slider-",
            ""
          ),
        10
      );
      ...
      currentFilterValues = exGetColumnFilterVal(oTable, column_number);
      if (
        +currentFilterValues.from === min_val &&
        +currentFilterValues.to === max_val
      ) {
        return;
      }
      ...
      buttonSelector
        .prev()
        .find(".yadcf-filter-range-number-slider")
        .slider("option", "yadcf-reset", true);
      buttonSelector
        .prev()
        .find(".yadcf-filter-range-number-slider")
        .slider("option", "values", [min_val, max_val]);

      $(buttonSelector.prev().find(".ui-slider-handle")[0])
        .attr("tabindex", -1)
        .focus();

      $(buttonSelector.prev().find(".ui-slider-handle")[0]).removeClass(
        "inuse"
      );
      $(buttonSelector.prev().find(".ui-slider-handle")[1]).removeClass(
        "inuse"
      );
      buttonSelector
        .prev()
    ...
    function dateKeyUP(table_selector_jq_friendly, date_format, event) {
      ...
      oTable = oTables[table_selector_jq_friendly];
      column_number = parseInt(
        dateId.replace("yadcf-filter-" + table_selector_jq_friendly + "-", ""),
        10
      );
      columnObj = getOptions(oTable.selector)[column_number];
      ...
      try {
        if (columnObj.datepicker_type === "jquery-ui") {
          if (date.length === date_format.length + 2) {
            date =
              date !== "" ? $.datepicker.parseDate(date_format, date) : date;
          }
        }
      } catch (err1) {}
      ...
      if (
        ...
        moment(date, columnObj.date_format).isValid()
      ) {
        $("#" + dateId).addClass("inuse");
        if (columnObj.filter_type !== "date_custom_func") {
    ...
    function rangeDateKeyUP(table_selector_jq_friendly, date_format, event) {
      ...
      column_number = parseInt(
        $(event.target)
          ...
          .replace("-from-date-", "")
          .replace("-to-date-", "")
          .replace("yadcf-filter-" + table_selector_jq_friendly, ""),
        10
      );
      columnObj = getOptions(oTable.selector)[column_number];
      settingsDt = getSettingsObjFromTable(oTable);
      ...
      keyUp = function() {
        ...
        if (
          (max instanceof Date && min instanceof Date && max >= min) ||
          !min ||
          !max
        ) {
          if (oTable.fnSettings().oFeatures.bServerSide !== true) {
            ...
            oTable.fnFilter(
              document.getElementById(fromId).value +
                columnObj.custom_range_delimiter +
                document.getElementById(toId).value,
              column_number_filter
            );
          }
    ...
    function rangeNumberKeyUP(table_selector_jq_friendly, event) {
      ...
      const target = checkbox
        ? $(event.target)
            .parent()
            .parent()
            .find(".yadcf-filter-range-number")
            .first()
        : $(event.target);
      $.fn.dataTableExt.iApiIndex = oTablesIndex[table_selector_jq_friendly];
      ...
      keyUp = function() {
        ...
        if (null_checked) {
          if (oTable.fnSettings().oFeatures.bServerSide !== true) {
            ...
            const excludeString = columnObj.not_null_api_call_value
              ? columnObj.not_null_api_call_value
              : "!^@";
            const nullString = columnObj.null_api_call_value
              ? columnObj.null_api_call_value
              : "null";
        ...
        if (
          ...
          if (oTable.fnSettings().oFeatures.bServerSide !== true) {
            ...
            oTable.fnFilter(
              exclude_delimeter + min + columnObj.custom_range_delimiter + max,
              column_number_filter
            );
          }
    ...
    function doFilterMultiTablesMultiSelect(
      ...
      var columnsObj = getOptions(tablesSelectors + "_" + column_number_str)[
          column_number_str
        ],
        regex = false,
        smart = true,
      ...
      if (
        ...
        if (columnsObj.column_number instanceof Array) {
          tablesAsOne
            .columns(columnsObj.column_number)
            .search("")
            .draw();
        } else {
        ...
        refreshSelectPlugin(
          columnsObj,
          $("#" + columnsObj.filter_container_id + " select"),
          "-1"
        );
        return;
      }
      ...
      if (columnsObj.column_number instanceof Array) {
        tablesAsOne
          .columns(columnsObj.column_number)
          .search(selected_values, regex, smart, caseInsen)
          .draw();
      } else {
    ...
    function doFilterMultiTables(
      ...
      if (columnsObj.column_number instanceof Array) {
        tablesAsOne
          .columns(columnsObj.column_number)
          .search(serachVal, regex, smart, caseInsen)
          .draw();
      } else {
    ...
    function textKeyUpMultiTables(
      ...
      var keyUp,
        columnsObj = getOptions(tablesSelectors + "_" + column_number_str)[
          column_number_str
        ],
        regex = false,
        smart = true,
	...
	*/
      ...
      keyUp = function(table_selector_jq_friendly, column_number, clear) {
        ...
        if (columnObj.regex_check_box === true) {
          regex_check_box = $(
            ...
            .closest(".yadcf-filter-wrapper")
            .find(".yadcf-regex-wrapper :checkbox")
            .prop("checked");
        }
        ...
        if (
          ...
          if (null_checked && columnObj.exclude) {
            if (oTable.fnSettings().oFeatures.bServerSide === true) {
              if (exclude) {
                columnObj.not_null_api_call_value = columnObj.not_null_api_call_value
                  ? columnObj.not_null_api_call_value
                  : "!^@";
                oTable.fnFilter(
                  columnObj.not_null_api_call_value,
                ...
                columnObj.null_api_call_value = columnObj.null_api_call_value
                  ? columnObj.null_api_call_value
                  : "null";
                oTable.fnFilter(
                  columnObj.null_api_call_value,
          ...
          $(
            fixedPrefix +
              ...
              "-" +
              column_number
          ).removeClass("inuse inuse-exclude inuse-regex");
          oTable.fnFilter("", column_number_filter);
          resetIApiIndex();
          return;
        }
        ...
        $(
          fixedPrefix +
            ...
            "-" +
            column_number
        ).removeClass("inuse-exclude inuse-regex");
        ...
        yadcfMatchFilter(
          ...
          regex_check_box ? "regex" : columnObj.filter_match_mode,
          column_number_filter,
          exclude,
          column_number
        );
    ...
    function nullChecked(ev, table_selector_jq_friendly, column_number) {
      ...
      click = function(table_selector_jq_friendly, column_number) {
        ...
        const inner =
          columnObj.filter_type === "range_number" ? "wrapper-inner-" : "";
        const inner_input =
          columnObj.filter_type === "range_number" ? " :input" : "";
        const input = $(
          "#yadcf-filter-" +
            inner +
            table_selector_jq_friendly +
    ...
    function isDOMSource(tableVar) {
      ...
      if (
        !settingsDt.sAjaxSource &&
        !settingsDt.ajax &&
        settingsDt.oFeatures.bServerSide !== true
      ) {
        return true;
      }
      return false;
    ...
    function scrollXYHandler(oTable, table_selector) {
      var $tmpSelector,
        filters_position = $(document).data(
          table_selector + "_filters_position"
        ),
        table_selector_jq_friendly = yadcf.generateTableSelectorJQFriendly2(
          oTable
        );
      ...
      if (
        oTable.fnSettings().oScroll.sX !== "" ||
        oTable.fnSettings().oScroll.sY !== ""
      ) {
        $tmpSelector = $(table_selector)
          .closest(".dataTables_scroll")
          .find(filters_position + " table");
        $tmpSelector.addClass(
          "yadcf-datatables-table-" + table_selector_jq_friendly
        );
      }
    }
    ...
    function initAndBindTable(oTable, table_selector, index, pTableDT) {
      var table_selector_jq_friendly = yadcf.generateTableSelectorJQFriendly2(
          oTable
        ),
        table_selector_tmp;
      ...
      if (isDOMSource(oTable)) {
        ...
        if (table_selector.indexOf(":eq") !== -1) {
          table_selector_tmp = table_selector.substring(
            0,
            table_selector.lastIndexOf(":eq")
          );
        }
        appendFilters(oTable, getOptions(table_selector_tmp), table_selector);
        if (
          getOptions(table_selector_tmp)[
            firstFromObject(getOptions(table_selector_tmp))
          ].cumulative_filtering === true
        ) {
          //when filters should be populated only from visible rows (non filtered)
          $(document)
            .off("search.dt", oTable.selector)
            .on("search.dt", oTable.selector, function(e, settings, json) {
        ...
        if (yadcfVersionCheck("1.10")) {
          $(document)
            .off("xhr.dt", oTable.selector)
            .on("xhr.dt", oTable.selector, function(e, settings, json) {
              var col_num,
                column_number_filter,
                table_selector_jq_friendly = generateTableSelectorJQFriendly2(
                  oTable
                );
              if (!json) {
                console.log(
                  "datatables xhr.dt event came back with null as data (nothing for yadcf to do with it)."
                );
                return;
              }
              ...
              for (col_num in yadcf.getOptions(settings.oInstance.selector)) {
                if (
                  yadcf
                    .getOptions(settings.oInstance.selector)
                    .hasOwnProperty(col_num)
                ) {
                  if (json["yadcf_data_" + col_num] !== undefined) {
                    column_number_filter = col_num;
                    if (
                      settings.oSavedState !== null &&
                      plugins[table_selector_jq_friendly] !== undefined
                    ) {
                      column_number_filter =
                        plugins[table_selector_jq_friendly].ColReorder[col_num];
                    }
                    yadcf.getOptions(settings.oInstance.selector)[
                      col_num
                    ].data = json["yadcf_data_" + column_number_filter];
                  }
                }
              }
            });
      ...
      if (yadcfVersionCheck("1.10")) {
        $(document)
          .off("stateLoaded.dt", oTable.selector)
          .on("stateLoaded.dt", oTable.selector, function(event, settings) {
            ...
            for (columnObjKey in args) {
              if (args.hasOwnProperty(columnObjKey)) {
                ...
                let table_selector_jq_friendly = yadcf.generateTableSelectorJQFriendly2(
                  oTable
                );
        ...
        $(document)
          .off("draw.dt", oTable.selector)
          .on("draw.dt", oTable.selector, function(event, settings) {
            appendFilters(
              oTable,
              yadcf.getOptions(settings.oInstance.selector),
        ...
        $(document)
          .off("column-visibility.dt", oTable.selector)
          .on("column-visibility.dt", oTable.selector, function(
            e,
            settings,
            col_num,
            state
            ...
            if (state === true && settings._oFixedColumns === undefined) {
              if (
                ...
                settings.oSavedState &&
                settings.oSavedState.ColReorder !== undefined
              ) {
                col_num = settings.oSavedState.ColReorder[col_num];
              }
              obj[col_num] = yadcf.getOptions(settings.oInstance.selector)[
                col_num
              ];
              if (obj[col_num] !== undefined) {
                ...
                if (obj[col_num] !== undefined) {
                  appendFilters(
                    oTables[yadcf.generateTableSelectorJQFriendly2(settings)],
                    obj,
                    settings.oInstance.selector,
                    settings
                  );
        ...
        $(document)
          .off("column-reorder.dt", oTable.selector)
          .on("column-reorder.dt", oTable.selector, function(
            e,
            settings,
            json
          ) {
            var table_selector_jq_friendly = generateTableSelectorJQFriendly2(
              oTable
            );
            initColReorderFromEvent(table_selector_jq_friendly);
          });
        $(document)
          .off("destroy.dt", oTable.selector)
          .on("destroy.dt", oTable.selector, function(event, ui) {
            removeFilters(
              oTable,
              yadcf.getOptions(ui.oInstance.selector),
              ui.oInstance.selector
            );
          });
      } else {
        $(document)
          .off("draw", oTable.selector)
          .on("draw", oTable.selector, function(event, settings) {
            appendFilters(
              oTable,
              yadcf.getOptions(settings.oInstance.selector),
              settings.oInstance.selector,
        ...
        $(document)
          .off("destroy", oTable.selector)
          .on("destroy", oTable.selector, function(event, ui) {
            removeFilters(
              oTable,
              yadcf.getOptions(ui.oInstance.selector),
              ui.oInstance.selector
      ...
      if (oTable.fnSettings().oFeatures.bStateSave === true) {
        if (yadcfVersionCheck("1.10")) {
          $(oTable.selector)
            .off("stateSaveParams.dt")
            .on("stateSaveParams.dt", function(e, settings, data) {
              if (
                settings.oLoadedState &&
                settings.oLoadedState.yadcfState !== undefined
              ) {
    ...
    $.fn.yadcf = function(options_arg, params) {
      ...
      if (
        params.filters_position === undefined ||
        params.filters_position === "header"
      ) {
      ...
      $(document).data(
        this.selector + "_filters_position",
        params.filters_position
      );
    ...
    function init(oTable, options_arg, params) {
      ...
      $(document).data(
        instance.selector + "_filters_position",
        params.filters_position
      );
    ...
    function appendFiltersMultipleTables(
      ...
      var filter_selector_string = "#" + colObjDummy.filter_container_id,
        table_selector_jq_friendly = yadcf.generateTableSelectorJQFriendlyNew(
          tablesSelectors
        ),
        options_tmp,
        ii,
        column_number_str = columnsArrayToString(colObjDummy.column_number)
          .column_number_str,
        tableTmp,
        tableTmpArr,
        tableTmpArrIndex,
        filterOptions = getOptions(tablesSelectors + "_" + column_number_str)[
          column_number_str
        ],
        column_number_index,
        columnsTmpArr,
      ...
      switch (filterOptions.filter_type) {
        case "text":
          $(filter_selector_string).append(
            '<input type="text" id="yadcf-filter-' +
              table_selector_jq_friendly +
              "-" +
              column_number_str +
              '" class="yadcf-filter" onmousedown="yadcf.stopPropagation(event);" onclick=\'yadcf.stopPropagation(event);' +
              "' placeholder='" +
              filterOptions.filter_default_label +
              "'" +
            ...
            $(filter_selector_string)
              ...
              .after(
                '<button type="button" ' +
                  ...
                  column_number_str +
                  '-reset" onmousedown="yadcf.stopPropagation(event);" ' +
                  "onclick=\"yadcf.stopPropagation(event);yadcf.textKeyUpMultiTables('" +
                  tablesSelectors +
                  "', event,'" +
                  column_number_str +
                  "','clear'); return false;\" class=\"yadcf-filter-reset-button " +
                  filterOptions.reset_button_style_class +
                  '">' +
                  filterOptions.filter_reset_button_text +
                  "</button>"
              );
          }
          ...
          if (
            ...
            tmpStr = yadcfParseMatchFilter(
              tmpStr,
              filterOptions.filter_match_mode
            );
            $(
              "#yadcf-filter-" +
                table_selector_jq_friendly +
        ...
        case "multi_select":
          ...
          if (filterOptions.data === undefined) {
            ...
            for (
              tableTmpArrIndex = 0;
              tableTmpArrIndex < tableTmpArr.length;
              tableTmpArrIndex++
            ) {
              if (tablesArray[tableTmpArrIndex].table !== undefined) {
                tableTmp = $(
                  "#" + tablesArray[tableTmpArrIndex].table().node().id
                ).dataTable();
              } else {
              ...
              if (isDOMSource(tableTmp)) {
                ...
                for (
                  ...
                  column_number_index < columnsTmpArr.length;
                  column_number_index++
                ) {
                  filterOptions.column_number =
                    columnsTmpArr[column_number_index];
                  filterOptions.data = filterOptions.data.concat(
                    parseTableColumn(
                      tableTmp,
                      filterOptions,
                      table_selector_jq_friendly
                ...
                $(document)
                  ...
                  .on(
                    ...
                    function(event, ui) {
                      ...
                      filterOptions.column_number = columnsTmpArr;
                      filterOptions.data = sortColumnData(
                        filterOptions.data,
                        filterOptions
                      );
                      for (ii = 0; ii < filterOptions.data.length; ii++) {
                        options_tmp +=
                          '<option value="' +
                          filterOptions.data[ii] +
                          '">' +
                          filterOptions.data[ii] +
                          "</option>";
                      }
                      $("#" + filterOptions.filter_container_id + " select")
                        .empty()
                        .append(options_tmp);

                      if (filterOptions.select_type !== undefined) {
                        initializeSelectPlugin(
                          filterOptions.select_type,
                          $(
                            "#" + filterOptions.filter_container_id + " select"
                          ),
                          filterOptions.select_type_options
                        );
                        if (
                          filterOptions.cumulative_filtering === true &&
                          filterOptions.select_type === "chosen"
                        ) {
                          refreshSelectPlugin(
                            filterOptions,
                            $(
                              "#" +
                                filterOptions.filter_container_id +
                                " select"
                            )
                          );
                        }
          ...
          if (typeof filterOptions.data[0] === "object") {
            for (ii = 0; ii < filterOptions.data.length; ii++) {
              options_tmp +=
                '<option value="' +
                filterOptions.data[ii].value +
                '">' +
                filterOptions.data[ii].label +
                "</option>";
            }
          } else {
            for (ii = 0; ii < filterOptions.data.length; ii++) {
          ...
          if (filterOptions.filter_type === "select") {
            $(filter_selector_string).append(
              '<select id="yadcf-filter-' +
                ...
                column_number_str +
                '" class="yadcf-filter" ' +
                "onchange=\"yadcf.doFilterMultiTables('" +
                tablesSelectors +
                "',event,'" +
                column_number_str +
                "')\" onmousedown=\"yadcf.stopPropagation(event);\" onclick='yadcf.stopPropagation(event);'>" +
            ...
            $(filter_selector_string).append(
              '<select multiple data-placeholder="' +
                ...
                column_number_str +
                '" class="yadcf-filter" ' +
                "onchange=\"yadcf.doFilterMultiTablesMultiSelect('" +
                tablesSelectors +
                "',event,'" +
                column_number_str +
                "')\" onmousedown=\"yadcf.stopPropagation(event);\" onclick='yadcf.stopPropagation(event);'>" +
              ...
              $(filter_selector_string)
                ...
                .after(
                  '<button type="button" ' +
                    ...
                    column_number_str +
                    '-reset" onmousedown="yadcf.stopPropagation(event);" ' +
                    "onclick=\"yadcf.stopPropagation(event);yadcf.doFilterMultiTables('" +
                    tablesSelectors +
                    "', event,'" +
                    column_number_str +
                    "','clear'); return false;\" class=\"yadcf-filter-reset-button " +
              ...
              $(filter_selector_string)
                ...
                .after(
                  '<button type="button" ' +
                    ...
                    column_number_str +
                    '-reset" onmousedown="yadcf.stopPropagation(event);" ' +
                    "onclick=\"yadcf.stopPropagation(event);yadcf.doFilterMultiTablesMultiSelect('" +
                    tablesSelectors +
                    "', event,'" +
                    column_number_str +
                    "','clear'); return false;\" class=\"yadcf-filter-reset-button " +
        ...
        default:
          alert(
            "Filters Multiple Tables does not support " +
    ...
    function initMultipleTables(tablesArray, filtersOptions) {
      ...
      for (
        columnsArrIndex = 0;
        columnsArrIndex < filtersOptions.length;
        columnsArrIndex++
      ) {
        dummyArr = [];
        ...
        if (columnsObj.filter_default_label === undefined) {
          if (
            columnsObj.filter_type === "select" ||
            columnsObj.filter_type === "custom_func"
          ) {
            columnsObj.filter_default_label = "Select value";
          } else if (
            columnsObj.filter_type === "multi_select" ||
            columnsObj.filter_type === "multi_select_custom_func"
          ) {
            columnsObj.filter_default_label = "Select values";
          } else if (
            columnsObj.filter_type === "auto_complete" ||
            columnsObj.filter_type === "text"
          ) {
            columnsObj.filter_default_label = "Type to filter";
          } else if (
            columnsObj.filter_type === "range_number" ||
            columnsObj.filter_type === "range_date"
          ) {
        ...
        column_number_str = columnsArrayToString(columnsObj.column_number)
          .column_number_str;
        ...
        tablesSelectors = tablesSelectors.substring(
          0,
          tablesSelectors.length - 1
        );
          ...
          switch (optionsObj.filter_type) {
            ...
            case "date":
              if (
                ...
                filter_value.indexOf("_exclude_") !== -1
              ) {
                exclude = true;
            ...
            case "range_date":
              ...
              if (table_arg.fnSettings().oFeatures.bServerSide === true) {
                ...
                table_arg.fnSettings().aoPreSearchCols[
                  column_position
                ].sSearch = min + optionsObj.custom_range_delimiter + max;
              }
              saveStateSave(
                table_arg,
                column_number,
            ...
            case "range_number":
              ...
              if (table_arg.fnSettings().oFeatures.bServerSide === true) {
                table_arg.fnSettings().aoPreSearchCols[
                  ...
                  filter_value.from +
                  optionsObj.custom_range_delimiter +
                  filter_value.to;
              }
              saveStateSave(
                table_arg,
            ...
            case "range_number_slider":
              ...
              if (filter_value.from !== "") {
                min = $("#" + fromId)
                  .closest(".yadcf-filter-range-number-slider")
                  .find(".yadcf-filter-range-number-slider-min-tip-hidden")
                  .text();
                max = $("#" + fromId)
                  .closest(".yadcf-filter-range-number-slider")
    ...
    function exGetColumnFilterVal(table_arg, column_number) {
      ...
      switch (optionsObj.filter_type) {
        ...
        case "date_custom_func":
          retVal = $filterElement.val();
          if (
            $filterElement.prev().hasClass("yadcf-exclude-wrapper") &&
            $filterElement
              .prev()
              .find("input")
              .prop("checked") === true
        ...
        default:
          console.log(
            "exGetColumnFilterVal error: no such filter_type: " +
              optionsObj.filter_type
          );
      }
      return retVal;
    }
    ...
    function exResetAllFilters(table_arg, noRedraw, columns) {
      ...
      for (columnObjKey in tableOptions) {
        if (tableOptions.hasOwnProperty(columnObjKey)) {
          ...
          if (
            columns !== undefined &&
            $.inArray(column_number, columns) === -1
          ) {
            continue;
          }
          $(document).removeData(
          ...
          let selectorePrefix = "";
          if (
            optionsObj.filters_position === "tfoot" &&
            settingsDt.oScroll.sX
          ) {
            selectorePrefix = ".dataTables_scrollFoot ";
          }
          $filterElement = $(
          ...
          switch (optionsObj.filter_type) {
            ...
            case "range_number":
              ...
              $(selectorePrefix + "#" + fromId).val("");
              $(selectorePrefix + "#" + fromId).removeClass(
                "inuse inuse-exclude"
              );
              $(selectorePrefix + "#" + toId).prop("disabled", false);
              $(selectorePrefix + "#" + toId).val("");
              $(selectorePrefix + "#" + toId).removeClass(
                "inuse inuse-exclude"
              );
              if (table_arg.fnSettings().oFeatures.bServerSide === true) {
                table_arg.fnSettings().aoPreSearchCols[column_number].sSearch =
            ...
            case "range_number_slider":
              ...
              $(selectorePrefix + "#" + toId)
                ...
                .find(".ui-slider-range")
                .removeClass("inuse");
              $(selectorePrefix + "#" + sliderId).slider("option", "values", [
                $("#" + fromId)
                  .parent()
                  .parent()
                  .find(".yadcf-filter-range-number-slider-min-tip-hidden")
    ...
    function exFilterExternallyTriggered(table_arg) {
      ...
      for (columnObjKey in columnsObj) {
        if (columnsObj.hasOwnProperty(columnObjKey)) {
          ...
          filterValue = exGetColumnFilterVal(
            table_arg,
            columnObj.column_number
          );
          filtersValuesSingleElem = [];
    ...
    function exRefreshColumnFilterWithDataProp(
      table_arg,
      col_num,
      updatedData
    ) {
